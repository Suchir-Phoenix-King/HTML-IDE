...
save_button = Button(root, image = save_img, text = "SaveFile", cursor = "star", command = save)
save_button.place(relx = 0.10, rely = 0.03, anchor = CENTER)

exit_button = Button(root, image = exit_img, text = "ExitFile", cursor = "star", command = closeWindow)
